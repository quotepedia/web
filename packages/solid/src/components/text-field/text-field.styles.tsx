...
export const styles = tv({
  slots: {
    wrapper: [
      "flex items-center justify-center w-full overflow-hidden rounded-xl outline-none ring-1 ring-inset ring-bg-secondary bg-bg-secondary/75 backdrop-blur-xl",
      ...
      "has-[:disabled]:cursor-not-allowed has-[:disabled]:ring-bg-secondary has-[:disabled]:opacity-50",
